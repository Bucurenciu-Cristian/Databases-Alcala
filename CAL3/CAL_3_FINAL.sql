...
VALUES (2022, 'Test Movie ABC', 120, 'English');


INSERT INTO cal2.movies (year, title, runtime, language)
VALUES (2022, 'Test Movie ABD', 110, 'Spanish');

UPDATE cal2.movies
SET runtime = 130
WHERE year = 2022
  AND title = 'Test Movie ABC';

DELETE
FROM cal2.movies
WHERE year = 2022
  AND title = 'Test Movie ABD';
...
\echo "average Reviews 10"
SELECT * FROM cal2.average_reviews limit 10;
\echo "Audit Log 10"
SELECT * FROM cal2.audit_log  order by id desc limit 10;
